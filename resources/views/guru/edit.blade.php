...
@section('breadcrumb', 'Admin Panel / Data Guru / Edit')
        ...
        <div class="col-lg-7">
            <div class="card-premium animate-fade-in">
                <div class="card-header">
                    <span><i class="fas fa-user-edit me-2" style="color: var(--accent);"></i> Edit Data Guru</span>
                </div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('guru.update', $guru->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                   ...
                                   id="keahlian"
                                   name="keahlian"
                                   value="{{ old('keahlian', $guru->keahlian) }}"
